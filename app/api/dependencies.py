...
async def get_security_context(
    ...
    """Resolve tenant and data permissions for the current request."""

    return build_security_context(principal)


async def get_sql_guard() -> SQLGuard:
    """Provide the stateless SQL security policy evaluator."""

    return SQLGuard()


async def get_result_masker() -> ResultMasker:
    """Provide the stateless result masking utility."""
...
async def get_query_service(
    ...
    result_masker: Annotated[ResultMasker, Depends(get_result_masker)],
) -> QueryService:
    """组装一次查询所需的业务服务"""
